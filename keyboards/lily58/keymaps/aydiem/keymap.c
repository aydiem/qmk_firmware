 ...
 * `-----------------------------------------/ Enter /     \ Space\-----------------------------------------'
 *                   | LGUI |LCTRL | LAlt | /LOWER  /       \RAISE \  |BackSP|Delete| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,   KC_MPLY, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
              KC_LGUI, KC_LCTRL, KC_LALT, LT(_LOWER, KC_ENT), LT(_RAISE, KC_SPC), KC_BSPC, KC_DEL, KC_RGUI \
),
/* GAMING
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  =   |
 ...
 * |LShift|   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |RShift|
 * `-----------------------------------------/ Enter /     \ Space\-----------------------------------------'
 *                   | LCTRL| LAlt |Space | /LOWER  /       \RAISE \  |BackSP|Delete| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
  [_GAMING] = LAYOUT( \
